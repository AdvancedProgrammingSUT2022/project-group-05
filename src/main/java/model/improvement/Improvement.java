...
public enum Improvement{
    CAMP(0, 0, 0, Research.TRAPPING,
            List.of(TUNDRA, FIELD, HILL),
            List.of(FOREST)
    ),
    FARM(1, 0, 0, Research.AGRICULTURE,
            List.of(FIELD, GRASS, DESERT),
            List.of()
    ),
    LUMBER_MILL(0, 0, 1, Research.CONSTRUCTION,
            List.of(),
            List.of(FOREST)
    ),
    MINE(0, 0, 1, Research.MINING,
            List.of(DESERT, FIELD, GRASS, TUNDRA, SNOW, HILL),
            List.of(FOREST, JUNGLE, MARSH)
    ),
    PASTURE(0, 0, 0, Research.ANIMAL_HUSBANDRY,
            List.of(FIELD, DESERT, GRASS, TUNDRA, HILL),
            List.of()
    ),
    PLANTATION(0, 0, 0, Research.CALENDAR,
            List.of(FIELD, DESERT, GRASS),
            List.of(FOREST, JUNGLE, MARSH, PLAIN)
    ),
    QUARRY(0, 0, 0, Research.MASONRY,
            List.of(FIELD, DESERT, GRASS, TUNDRA, HILL),
            List.of()
    ),
    TRADING_POST(0, 1, 0, Research.TRAPPING,
            List.of(FIELD, DESERT, GRASS, TUNDRA),
            List.of()
    ),
    FACTORY(0, 0, 2, Research.ENGINEERING,
            List.of(FIELD, DESERT, GRASS, TUNDRA, SNOW),
            List.of()
    );

    //TODO... implement construction time
    ...
    Improvement(int food, int gold, int production, Research prerequisite,
