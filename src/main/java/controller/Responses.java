...
public enum Responses{
    ...
    NO_MARSH_IN_TILE("error: no marsh on current tile"),
    NO_ROUTE_IN_TILE("error: no route on current tile"),
    NO_IMPROVEMENT_IN_TILE("error: no improvement on current tile"),
    FEATURE_AND_IMPROVEMENT_ERROR("error: can't remove feature of a tile with improvement"),
    ALREADY_REPAIRED("error: tile already repaired"),
        //MESSAGES
    IMPROVEMENT_DONE("improvement construction started"),
    ROUTE_DONE("route construction started"),
    FOREST_REM_DONE("forest removal started"),
    JUNGLE_REM_DONE("jungle removal started"),
    MARSH_REM_DONE("marsh removal started"),
    ROUTE_REM_DONE("route removal started"),
    IMPROVEMENT_REM_DONE("improvement removal started"),
